        ...
        fetch(img_hosting_url, {
            ...
            .then(imgResponse => {
                if (imgResponse.success) {
                    ...
                    const { language, description, price, seats, title, lesson } = data;
            ...
            <div className="w-full mx-auto px-10 ms-10 shadow-md mt-5 ">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-5 md:w-[992px] mx-auto">
                    ...
                    <div className="flex gap-5 mt-5">
                        ...
                        <div className="form-control w-full ">
                            <label className="label">
                                <span className="label-text font-bold">Total Lesson*</span>
                            </label>
                            <input type="text" placeholder="Lesson" {...register("lesson", { required: true })} className="input input-bordered w-full " />
                            {errors.seats?.type === 'required' && (
                                <p className='text-red-600 mt-2' role='alert'>
                                    Seat is required
                                </p>
                    ...
                    <div className="form-control mt-5">
                        ...
                        <textarea
                            ...
                            placeholder="Description max 200 characters long"
                        ></textarea>
                        ...
                        {errors.description?.type === "maxLength" && (
                            <p className="text-red-600 mt-2" role="alert">
                                Description max 200 characters long
                            </p>
                        )}
                    </div>
                    ...
                    <input className="btn border-solid border-2 border-black mt-4 " type="submit" value="Add Class" />
