    ...
    return (
        <>
            ...
            <div data-aos="fade-up"
                data-aos-duration="3000" className='-z-50 ' style={{ height: '680px', backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("https://i.ibb.co/Mn3Pj1N/cursos-de-idiomas-elearning-Classroom-Companion.jpg")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                <div data-aos="flip-left"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="2000" className="flex items-center p-5 justify-start h-full ">
